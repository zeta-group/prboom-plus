...
default_t defaults[] = {
    ...
    }, // percentage of normal speed (35 fps) realtic clock runs at
    {
        ...
        def_bool,ss_none
    }, // do Boom fullscreen menus have backgrounds?
    {
        "max_player_corpse", {&bodyquesize}, {32},-1,UL,   // killough 2/8/98
        def_int,ss_none
    }, // number of dead bodies in view supported (-1 = no limit)
    {
        "flashing_hom",{&flashing_hom},{0},0,1,
        def_bool,ss_none
    }, // killough 10/98 - enable flashing HOM indicator
    {
    ...
    }, // 1=take special steps ensuring demo sync, 2=only during recordings
    {
        ...
        def_hex, ss_none
    }, // 0, +1 for colours, +2 for non-ascii chars, +4 for skip-last-line
    {
    ...
    },
    {
        ...
        def_bool,ss_stat
    }, // makes percent signs on status bar always gray
    {
        "sts_traditional_keys",{&sts_traditional_keys},{0},0,1,  // killough 2/28/98
        def_bool,ss_stat
    }, // disables doubled card and skull key display on status bar
    {
    ...
    {"Dehacked settings",{NULL},{0},UL,UL,def_none,ss_none},
    {
        ...
        def_bool,ss_stat
    }, // if 0, dehacked cheat replacements are ignored.
    ...
    {"snd_pcspeaker",{&snd_pcspeaker},{0}, 0, 1, def_bool,ss_none},
    {
        ...
        def_int,ss_none
    }, // select sounds driver (DOS), -1 is autodetect, 0 is none; in Linux, non-zero enables sound
    {
        "music_card",{&mus_card},{-1},-1,9,       //  to be set,  -1 = autodetect
        def_int,ss_none
    }, // select music driver (DOS), -1 is autodetect, 0 is none"; in Linux, non-zero enables music
    {
        "pitched_sounds",{&pitched_sounds},{0},0,1, // killough 2/21/98
        def_bool,ss_none
    }, // enables variable pitch in sound effects (from id's original code)
    ...
    {"music_volume",{&snd_MusicVolume},{8},0,15, def_int,ss_none},
    {
        ...
        def_int, ss_none
    }, // 0 = kill music when paused, 1 = pause music, 2 = let music continue
    {
        "snd_channels",{&default_numChannels},{32},1,32,
        def_int,ss_none
    }, // number of audio events simultaneously // killough
#ifdef _WIN32
...
#ifdef _WIN32
    {
        ...
        def_bool,ss_none
    }, // e6y: apply midi volume to all midi devices
#endif
    ...
    },
    {
        ...
        def_int,ss_none
    }, // gamma correction level // killough 1/18/98
    {
    ...
    },
    {
        ...
        def_int,ss_none
    }, // amount to bring items out of floor (GL) Mead 8/13/03
    {
...
// CPhipps - now they're the doom codes, so default.cfg can be portable
    ...
    }, // key to clear a key binding
    {
        ...
        0,MAX_KEY,def_key,ss_keys
    }, //e6y: key for entering setup menu
    {
    ...
    }, // key to restore from saved games
    {
        ...
        0,MAX_KEY,def_key,ss_keys
    }, // key to bring up sound controls
    {
    ...
    }, // key to quit game
    {
        ...
        0,MAX_KEY,def_key,ss_keys
    }, // key to adjust gamma correction
    {
        "key_spy",         {&key_spy},            {KEYD_F12},
        0,MAX_KEY,def_key,ss_keys
    }, // key to view from another coop player's view
    {
    ...
    }, // backspace key
    {
        ...
        0,MAX_KEY,def_key,ss_keys
    }, // key to select from menu or see last message
    {
    ...
    }, // key to toggle grid display over automap
    {
        ...
        0,MAX_KEY,def_key,ss_keys
    }, // key to toggle rotating the automap to match the player's orientation
    {
        "key_map_overlay", {&key_map_overlay},     {'o'},
        0,MAX_KEY,def_key,ss_keys
    }, // key to toggle overlaying the automap on the rendered display
#ifdef GL_DOOM
    {
        "key_map_textured", {&key_map_textured},   {0},
        0,MAX_KEY,def_key,ss_keys
    }, // key to toggle textured automap
#endif
    {
    ...
    }, // key to switch to weapon 8 (chainsaw)        //    |
    {
        ...
        0,MAX_KEY,def_key,ss_keys
    }, // key to switch to weapon 9 (supershotgun)    // phares
    {
    ...
    {"Joystick settings",{NULL},{0},UL,UL,def_none,ss_none},
    {
        ...
        def_int,ss_none
    }, // number of joystick to use (0 for none)
    ...
    }, // joystick button number to use for strafing
    {
        ...
        def_int,ss_keys
    }, // joystick button number to use for strafe left
    {
        "joyb_straferight",{&joybstraferight},{5},0,UL,
        def_int,ss_keys
    }, // joystick button number to use for strafe right
    {
    ...
    //jff 3/9/98 add option to not show secrets til after found
    {
        ...
        def_bool,ss_auto
    }, // prevents showing secret sectors till after entered
    {
    ...
    }, // color range used for automap coordinates
    {
        ...
        def_int,ss_auto
    }, // color range used for automap statistics for titles
    {
        "hudcolor_mapstat_value", {&hudcolor_mapstat_value}, {2},0,9,    // gray range
        def_int,ss_auto
    }, // color range used for automap statistics for data
    {
        "hudcolor_mapstat_time", {&hudcolor_mapstat_time}, {2},0,9,    // gray range
        def_int,ss_auto
    }, // color range used for automap statistics for level time and total time
    {
    ...
    }, // color range used for message review
    {
        ...
        def_int,ss_mess
    }, // number of messages in review display (1=disable)
    {
        "hud_list_bgon", {&hud_list_bgon}, {0},0,1,  // solid window bg ena //jff 2/26/98
        def_bool,ss_mess
    }, // enables background window behind message review
